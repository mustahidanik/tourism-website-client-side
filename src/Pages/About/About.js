...
const About = () => {
    return (
        <div id="about" className="py-5 w-75 mx-auto ">
            <h2><span>About Us</span></h2>
            <div className="about mt-3">
                <h3>Why should you visit <span>ADMIRIC TOUR & TRAVELS??</span></h3>
                <p>Pack your bags. We’re going on vacation!
                    ...
                    That’s why in this post, I’ll cover the essential elements your site needs to include, then go over 20 examples of travel sites you can use to inspire your own design.</p>
            </div>
        </div>
    );
};
